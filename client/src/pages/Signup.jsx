        ...
        <Col md={7} lg={6}>
          <Card className="animate-fade-in-up shadow-lg glass-card border-0" style={{ boxShadow: '0 15px 35px rgba(0,0,0,0.6), inset 0 0 20px rgba(0, 240, 255, 0.05)', border: '1px solid rgba(0, 240, 255, 0.1)', background: 'rgba(11, 14, 20, 0.4)' }}>
            <Card.Body className="p-5">
              <h2 className="text-center mb-4 fw-bold gradient-text" style={{fontFamily: 'Outfit'}}>Create Account</h2>
              <p className="text-center text-light opacity-75 mb-4">Join Campus Compass AI today</p>
              ...
              <Form onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <span className="text-light opacity-75">Already have an account? </span>
