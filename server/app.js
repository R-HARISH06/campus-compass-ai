...
app.get("/api/factory-reset", async (req, res) => {
    try {
        const { execSync } = require('child_process');
        execSync('node config/factory_reset.js', { cwd: __dirname });
        res.send("Factory Reset Complete! All old data is restored flawlessly.");
    } catch (err) {
        console.error(err);
